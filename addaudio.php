<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO `product` (`product_name`, `product_price`, `product_image`, `product_battery`, `product_category`) VALUES ('$name', '$price', '$image', '$battery', 'Audio')";
    ...
    <body>
        ...
        <div class="container">
            ...
            <select class="producttype" name="producttype" onchange="window.location=this.value" required>
                ...
                <option value="addaudio.php" disabled selected hidden>Audio</option>
            </select>
            <div class="line"></div>
            <br><br><br>
            <form method="POST">
