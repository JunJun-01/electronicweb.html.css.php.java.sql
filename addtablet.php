<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO `product` (`product_name`, `product_price`, `product_image`, `product_display`, `product_memory`, `product_os`, `product_camera`, `product_battery`, `product_ram`, `product_gpu`, `product_cpu`, `product_category`) VALUES ('$name', '$price', '$image', '$display', '$memory', '$os', '$camera', '$battery', '$ram', '$gpu', '$cpu', 'Tablet')";
    ...
    <body>
        ...
        <div class="container">  
            ...
            <select class="producttype" name="producttype" onchange="window.location=this.value" required>
                ...
                <option value="addtablet.php" disabled selected hidden>Tablet</option>
