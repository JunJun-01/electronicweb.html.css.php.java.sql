...
<head>
    ...
    <title>Electron -ProductPage</title>
</head>
<body>
							...
							<div class="checkbox-filter">
								...
								<div class="input-checkbox">
									...
									<label for="category-1">
										<a href=""  style = 'color:#D10024'><span>All Products</span></a>
								...
								<div class="input-checkbox">
									...
									<label for="category-5">
										<a href="phone.php"><span>Phones</span></a>
						...
						<div class="row">
                            ...
                            <?php
                                ...
                                foreach($result as $result){
                                    ...
                                    echo"<h3 class='product-name' name='productid'><a href='specificproduct.php?id=$id'>$name</a></h3>";
                                    ...
                                    echo"<h4 class='product-price' name='price'>$$price </h4>";
                                    echo"</div>";
